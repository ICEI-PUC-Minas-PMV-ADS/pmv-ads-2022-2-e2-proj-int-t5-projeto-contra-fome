...
|RF-011| O sistema deve apresentar a possibilidade de buscar locais de doação   | ALTA |
|RF-012| O sistema deve apresentar a possibilidade de mostrar os locais de doação   | ALTA |
